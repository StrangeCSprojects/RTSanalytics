...
def test_determine_build(setup_database):
    ...
    user_commands = [
        (("UnitInitEvent", "SupplyDepot"), 12),
        (("UnitInitEvent", "Barracks"), 22),
        (("UnitInitEvent", "CommandCenter"), 50),
        (("UnitInitEvent", "Factory"), 90),
        (("UnitInitEvent", "Barracks"), 100),
        (("UnitInitEvent", "Barracks"), 110),
        (("UnitInitEvent", "Starport"), 110),
        (("UnitInitEvent", "Barracks"), 150),
        (("UnitInitEvent", "Barracks"), 150),
        (("UnitInitEvent", "Barracks"), 170),
        (("UnitInitEvent", "EngineBay"), 170),
        (("UnitInitEvent", "SupplyDepot"), 200),
        (("UnitInitEvent", "Barracks"), 250),
        (("UnitInitEvent", "CommandCenter"), 275),
        (("UnitInitEvent", "Factory"), 300),
        (("UnitInitEvent", "Barracks"), 400),
        (("UnitInitEvent", "Barracks"), 410),
        (("UnitInitEvent", "Starport"), 510),
        (("UnitInitEvent", "Barracks"), 750),
        (("UnitInitEvent", "Barracks"), 950),
        (("UnitInitEvent", "Barracks"), 1070),
        (("UnitInitEvent", "EngineBay"), 1070),
    ]
...
def test_compare_build_orders(setup_database):
    ...
    user_commands = [
        (("UnitBornEvent", "SCV"), 1),
        (("UnitBornEvent", "SCV"), 7),
        (("UnitInitEvent", "Barracks"), 12),
        (("UnitInitEvent", "Barracks"), 35),
        (
            ("UnitInitEvent", "Barracks"),
            35,
        ),  # Duplicate entry to test handling of repeated commands.
        (("UnitInitEvent", "Starport"), 75),
        (("UnitInitEvent", "CommandCenter"), 100),
        (("UnitInitEvent", "Barracks"), 122),
        (("UnitInitEvent", "Barracks"), 146),
    ...
    assert (
        round(
            determine_build._compare_build_orders(benchmark_commands, user_commands), 2
        )
        == 76.56
    )
...
def test_relative_error_of_unit_type(setup_database):
    ...
    assert (
        round(
            determine_build._relative_error_of_unit_type(
                benchmark_unit_dictionary, user_unit_dictionary, unit_type_one
            ),
            2,
        )
        == 0.47
    ...
    assert (
        round(
            determine_build._relative_error_of_unit_type(
                benchmark_unit_dictionary, user_unit_dictionary, unit_type_two
            ),
            2,
        )
        == 0.14
    ...
    assert (
        round(
            determine_build._relative_error_of_unit_type(
                benchmark_unit_dictionary, user_unit_dictionary, unit_type_three
            ),
            2,
        )
        == 0.08
    ...
    assert (
        round(
            determine_build._relative_error_of_unit_type(
                benchmark_unit_dictionary, user_unit_dictionary, unit_type_four
            ),
            2,
        )
        == 0.25
...
def test_load_unit_dictionary(setup_database):
    ...
    assert unit_dictionary == {
        ("UnitInitEvent", "Barracks"): [5],
        ("UnitInitEvent", "SupplyDepot"): [7],
    }
...
def test_pad_user_unit_dictionary(setup_database):
    ...
    pads the user's dataset with large values for missing timestamps, making the user's dataset
    have the same length as the benchmark.
    """
    benchmark_unit_dictionary = {
        ("UnitInitEvent", "Barracks"): [20, 180, 181, 185, 300, 301, 302, 303]
    }
    user_unit_dictionary = {
        ("UnitInitEvent", "Barracks"): [22, 180, 181, 300, 301, 303]
    }
    unit_type = ("UnitInitEvent", "Barracks")

    # Expected outcome after padding the user dictionary to match the benchmark
    padded_dictionary = {
        ("UnitInitEvent", "Barracks"): [22, 180, 181, 300, 301, 303, 10000, 10000]
    }
    ...
    determine_build._pad_user_unit_dictionary(
